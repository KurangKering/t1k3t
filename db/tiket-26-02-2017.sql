...
-- Dumping data for table tiket.penjualan: ~3 rows (approximately)
/*!40000 ALTER TABLE `penjualan` DISABLE KEYS */;
INSERT INTO `penjualan` (`booking_code`, `id_tc`, `id_maskapai`, `tanggal`, `hpp`, `persen`, `invoice`, `q`, `fee`) VALUES
	('111', 1, 1, '2017-02-21', 654100, 0.0500, 232, 2, 10000),
	('1231231', 2, 3, '2017-02-07', 654100, 0.0500, 725100, 5, 10000),
	('43342', 1, 1, '2017-02-13', 12312, 0.0500, 232, 23, 10000);
